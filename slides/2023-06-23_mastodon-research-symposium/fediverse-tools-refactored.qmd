...
instances_df <- read.csv("slides/2023-06-23_mastodon-research-symposium/data/rtoot_instances.csv")
...
```{r}
#| classes: small-text
fedidb_servers <- read.csv("slides/2023-06-23_mastodon-research-symposium/data/fedidb_servers.csv") 
...
```{r}
#| classes: small-text
read.csv("slides/2023-06-23_mastodon-research-symposium/data/fedidb_software.csv") |> 
  head(3) |> 
  datatable()
```
